  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-600 text-center">Join EmberDrive today</p>
          </div>
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?q=80&w=1000')"
        }}
      >
        <div className="w-full h-full bg-gradient-to-br from-primary-900/90 to-dark-900/90 flex items-center justify-center p-12">
          <div className="max-w-md text-white">
            <h2 className="text-4xl font-bold mb-6">Join EmberDrive</h2>
            <p className="text-lg text-gray-200">
              Create your account and unlock access to our premium fleet of vehicles. Start your journey with us today.
            </p>
          </div>
        </div>
      </div>
